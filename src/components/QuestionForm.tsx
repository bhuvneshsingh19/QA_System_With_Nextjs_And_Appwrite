 ...
 * ******************************************************************************
 */
type QuestionDocument = Models.Document & { content?: string; title?: string; tags?: string[]; attachmentId?: string };
...
const QuestionForm = ({ question }: { question?: QuestionDocument }) => {
    ...
    const update = async () => {
        ...
        const attachmentId = await (async () => {
            if (!formData.attachment) return (question as any).attachmentId as string;

            await storage.deleteFile(questionAttachmentBucket, (question as any).attachmentId);
